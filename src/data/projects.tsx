...
const projects: Project[] = [
  ...
  //   github: "https://github.com/petrus-handika/Coding-Ducks",
  //   get content() {
  //     return (
  //       <div>
  ...
  //   screenshots: ["1.png"],
  //   live: "http://petrushandika.vercel.app",
  //   github:"https://github.com/petrus-handika/Portfolio",
  //   skills: {
  //     frontend: [
  //       PROJECT_SKILLS.ts,
  //       PROJECT_SKILLS.next,
  ...
  //   github:"https://github.com/petrus-handika/GhostChat",
  //   skills: {
  ...
  //   screenshots: ["1.png"],
  //   live: "https://petrus-handika.github.io/JNTUA-result-analyser-spa/#/",
  //   skills: {
  ...
  // +
  {
    ...
    github: "https://github.com/petrushandika/AI-Docker-file-optimizer",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.next,
  ...
  },
  {
    ...
    live: "https://github.com/petrushandika/FinanceMe-Devops-Project-01",
    github: "https://github.com/petrushandika/FinanceMe-Devops-Project-01",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
  ...
  },
  {
    ...
    live: "https://www.petrushandikasinaga.com/",
    github: "https://github.com/petrushandika/3D-interactive-portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  },
  {
    ...
    live: "https://github.com/petrushandika/smart-parking-assistant",
    github: "https://github.com/petrushandika/smart-parking-assistant",
    skills: {
  ...
  },
  {
    ...
    github: "https://github.com/petrushandika/Job-tracker-application",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.next,
  ...
  },
  {
    ...
    github: "https://github.com/petrushandika/savinder-puri",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.next,
      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            a mentor who transforms lives. 💻🕊️ Crafted with ❤️ by Petrus Zende!
            🚀
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
